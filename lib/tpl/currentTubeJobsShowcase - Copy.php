        ...
        <?php if ($job): ?>
            ...
            <div class="row show-grid">
                ...
                <div class="col-sm-9">
                    ...
                    <pre id="json-viewer" class="rounded-2 my-2">
                        <code class="bg-black text-white bg-opacity-50 text-break"><?php echo htmlspecialchars(trim(var_export($job['data'], true), "'"), ENT_COMPAT) ?></code></pre>
                </div>
            </div>
        <?php else: ?>
            <i>empty</i>
